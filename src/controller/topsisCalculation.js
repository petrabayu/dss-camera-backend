...
const TOPSISCalculation = async (req, res) => {
  try {
    ...
    console.log("Matriks Alternatif Setelah Transformasi:", transformedMatrix);
    ...
    try {
      ...
      res.status(201).json({
        ...
        idealSolution: idealSolution, // Ganti dengan hasil yang sebenarnya setelah perhitungan selesai
      });
    } catch (calcError) {
